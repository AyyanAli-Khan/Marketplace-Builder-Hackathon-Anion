              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center ml-4 space-x-2">
                  ...
                  <button
                    ...
                    className="text-white bg-primary font-satoshi font-[300] hover:bg-secondary rounded-l-md py-[12px] px-[20px] transition"
                  >
                    -
                  </button>

                  {/* Quantity Display */}
                  <span className="px-4 text-primary font-satoshi text-h6">
                    {quantity}
                  </span>
                  ...
                  <button
                    ...
                    className="text-white bg-primary hover:bg-secondary font-satoshi font-[300] rounded-r-md py-[12px] px-[20px] transition"
                  >
                    +
                  </button>
                </div>
